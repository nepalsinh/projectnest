...
const sendVerificationEmail = (to, token) => {
    const subject = "Email verification - ProjectNest";
...
const sendTaskAssignMail = (to, task) => {
    const subject = 'Task Assigned - ProjectNest';
...
const sendInviteMail = (to, project, role) => {
    const subject = "Invitation to join Project - ProjectNest";
